...
class Faculty(Member):
    ...
    def __init__(self, name, address, email, faculty_number):
    ...
    def __str__(self):
        ...
        return '''{}\n{}\nCourses: {}'''.format(
            member_string, self.faculty_number,
...
class Student(Member):
    ...
    def __init__(self, name, address, email, student_number):
        ...
        student number student_num, an empty list of courses tken, and an empty
